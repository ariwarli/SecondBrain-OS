...
- `openclaw.md` + config/runtime lokal dipakai untuk state aktual.
...
Telegram untuk perintah. Todoist untuk visibilitas.
...
Load only SOUL.md, USER.md, IDENTITY.md, openclaw.md, and daily.md.
Do not auto-load MEMORY.md, old chat logs, or prior session transcripts.
Fetch crm.md, openclaw-rules.md, prompts.md, and projects/*.md only on demand.
```
...
# NotebookLM Chief of Staff Protocol
1. Context Minimization: Selalu baca (load) SOUL.md, USER.md, IDENTITY.md, openclaw.md, dan daily.md di awal sesi yang baru untuk memahami konteks harian dan identitas Anda.
2. Jangan baca file crm.md, prompts.md, atau folder projects/ secara otomatis, KECUALI jika konteks permintaan secara spesifik membutuhkan referensi tersebut.
3. Gunakan subagent (reed-researcher, reed-builder, reed-archivist) untuk tugas berdurasi >10 menit (seperti riset mendalam atau pembuatan draf panjang).
4. Gunakan qmd search (hybrid) atau neural-memory (mempalace) untuk merujuk pada catatan masa lalu.
