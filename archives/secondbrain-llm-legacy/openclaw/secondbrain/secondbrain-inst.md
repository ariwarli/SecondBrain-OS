...
- scheduler, alert, dan automation dijalankan lewat automation layer REED
...
- semua operasi utama tetap lewat `@survivorset_bot`
...
Scheduler, alert, dan heartbeat adalah automation layer internal REED, bukan bot kerja terpisah.
...
- tidak ada bot kedua untuk scheduler
- default tanpa mention
- mention REED kalau perlu eksplisit
- jangan pisahkan kerja harian dari jalur utama REED
