...
- reminder, alert, dan scheduler tetap dianggap bagian dari REED
...
- tidak perlu mention bot lain untuk scheduler
...
- test scheduler path legacy:
  - `@survivorset_bot Cek health scheduler sekarang.`
- kalau REED diam:
  - cek `ops playbook`
  - jangan pakai `General` sebagai patokan
- kalau scheduler mati:
  - cek automation layer REED
